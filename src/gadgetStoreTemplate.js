export const gadgetStoreTemplate = {
  id: 'gadget-store',
  name: 'Gadget Store',
  ...
  html: `
    ...
    <div id="wrapper">
      <!-- Announcement Bar -->
      <div class="announcement-bar bg_blue">
        <div class="px_15 lg-px_40">
          <div class="row justify-content-center">
            <div class="col-xl-3 col-md-4 col-12 text-center wrap-announcement-bar-2">
              <div dir="ltr" class="swiper tf-sw-top_bar" data-preview="1" data-space="0" data-loop="true" data-speed="1000" data-delay="2000">
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <p class="noti-bar-text text-white fw-5">
              ...
              <div class="navigation-topbar nav-next-topbar">
                <span class="icon icon-arrow-left"></span>
              </div>
              <div class="navigation-topbar nav-prev-topbar">
            ...
            <div class="col-xl-5 tf-md-hidden">
              <nav class="box-navigation text-center">
                <ul class="box-nav-ul d-flex align-items-center gap-30">
                  ...
                  <li class="menu-item">
                    <a class="item-link" href="/shop-collection">Shop</a>
                  </li>
                  <li class="menu-item">
                    <a class="item-link" href="/about-us">About Us</a>
                  </li>
                  <li class="menu-item position-relative">
                    <a class="item-link" href="/contact">Contact Us</a>
                  </li>
                </ul>
              </nav>
            </div>
            ...
            <div class="col-xl-5 col-md-4 col-3">
              <ul class="nav-icon d-flex justify-content-end align-items-center gap-20">
                ...
                <li class="nav-wishlist">
                  <a class="nav-icon-item" href="/wishlist"><i class="icon icon-heart"></i><span class="count-box bg-dark">0</span></a>
                </li>
                <li class="nav-cart">
                  <a href="#shoppingCart" data-bs-toggle="modal" class="nav-icon-item"><i class="icon icon-bag"></i><span class="count-box bg-dark">2</span></a>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section class="tf-slideshow slider-effect-fade slider-accessories">
        <div dir="ltr" class="swiper tf-sw-slideshow" data-preview="1.6" data-tablet="1" data-mobile="1" data-centered="true" data-space="30" data-loop="true" data-auto-play="true" data-delay="2000" data-speed="1000">
          <div class="swiper-wrapper">
            <div class="swiper-slide" lazy="true">
              <div class="wrap-slider">
                <img src="images/accessories2_slideshow1.jpg" alt="Audio-slideshow">
                <div class="box-content text-center">
                  <div class="container">
                    <h2 class="fade-item fade-item-1 heading">
                      Mix. Match. MagSafe
                    </h2>
                    ...
                    <div class="fade-item fade-item-3">
                      <a class="tf-btn btn-outline-dark fw-5 btn-xl radius-60" href="/shop-default"><span>Shop collection</span><i class="icon icon-arrow-right"></i></a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="swiper-slide" lazy="true">
              <div class="wrap-slider">
                <img src="images/accessories2_slideshow2.jpg" alt="Audio-slideshow">
                <div class="box-content text-center">
                  <div class="container">
                    <h2 class="fade-item fade-item-1 heading">
                      Urbanluxe Docking
            ...
            <div class="swiper-slide" lazy="true">
              <div class="wrap-slider">
                <img src="images/accessories2_slideshow3.jpg" alt="Audio-slideshow">
                <div class="box-content text-center">
                  <div class="container">
                    <h2 class="fade-item fade-item-1 heading">
                      Accessory Sale
                    ...
                    <p class="fade-item fade-item-2">
                      Up to 40% off chargers, earbuds, and more.
                    </p>
                    <div class="fade-item fade-item-3">
                      <a class="tf-btn btn-outline-dark fw-5 btn-xl radius-60" href="/shop-default"><span>Shop collection</span><i class="icon icon-arrow-right"></i></a>
                    </div>
                ...
                <div class="swiper-slide">
                  <div class="tf-icon-box style-row">
                    ...
                    <div class="content">
                      ...
                      <p>
                        Free shipping over order <i class="fa fa-inr"></i> 120
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section class="flat-spacing-2">
        <div class="container">
          ...
          <div class="wrap-carousel wrap-sw-3">
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide" lazy="true">
                  <div class="card-product style-8 border-0 bg_grey-11">
                    <div class="card-product-wrapper">
                      <a class="product-img" href="/product-detail">
                        <img class="lazyload img-product" data-src="images/products/item1.png" src="images/item1.png" alt="image-product">
                        <img class="lazyload img-hover" data-src="images/products/item1.png" src="images/item1.png" alt="image-product">
                      </a>
                    ...
                    <div class="card-product-info text-center">
                      <a class="title link" href="/product-detail">Case with MagSafe</a>
                      <span class="price"><i class="fa fa-inr"></i> 1,200</span>
                      <ul class="list-color-product justify-content-center">
                        <li class="list-color-item color-swatch active">
                          <span class="tooltip">Blue</span>
                          <span class="swatch-value bg_blue-2"></span>
                          <img class="lazyload" data-src="images/products/bark-phone-blue.jpg" src="images/bark-phone-blue.jpg" alt="image-product">
                        </li>
                        <li class="list-color-item color-swatch">
                          <span class="tooltip">Black</span>
                          <span class="swatch-value bg_dark"></span>
                          <img class="lazyload" data-src="images/products/bark-phone-black.jpg" src="images/bark-phone-black.jpg" alt="image-product">
                        </li>
                        <li class="list-color-item color-swatch">
                          <span class="tooltip">Orange</span>
                          <span class="swatch-value bg_orange-3"></span>
                          <img class="lazyload" data-src="images/products/bark-phone-orange.jpg" src="images/bark-phone-orange.jpg" alt="image-product">
                        </li>
                        <li class="list-color-item color-swatch">
                          <span class="tooltip">Green</span>
                          <span class="swatch-value bg_green"></span>
                          <img class="lazyload" data-src="images/products/bark-phone-green.jpg" src="images/bark-phone-green.jpg" alt="image-product">
                        </li>
                        <li class="list-color-item color-swatch">
                          <span class="tooltip">Light Brown</span>
                          <span class="swatch-value bg_light-brown"></span>
                          <img class="lazyload" data-src="images/products/bark-phone-light-brown.jpg" src="images/bark-phone-light-brown.jpg" alt="image-product">
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div class="swiper-slide" lazy="true">
                  <div class="card-product style-8 border-0 bg_grey-11">
                    <div class="card-product-wrapper">
                      <a class="product-img" href="/product-detail">
                        <img class="lazyload img-product" data-src="images/products/item2.png" src="images/item2.png" alt="image-product">
                        <img class="lazyload img-hover" data-src="images/products/item2.png" src="images/item2.png" alt="image-product">
                      </a>
                      <div class="list-product-btn absolute-2">
                        <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                          <span class="icon icon-bag"></span>
                    ...
                    <div class="card-product-info text-center">
                      <a class="title link" href="/product-detail">MagSafe 3 Cable</a>
                      <span class="price"><i class="fa fa-inr"></i> 2,999</span>
                      <ul class="list-color-product justify-content-center">
                        <li class="list-color-item color-swatch active">
                          <span class="tooltip">Black</span>
                          <span class="swatch-value bg_dark"></span>
                          <img class="lazyload" data-src="images/products/cable-black.jpg" src="images/cable-black.jpg" alt="image-product">
                        </li>
                        <li class="list-color-item color-swatch">
                          <span class="tooltip">White</span>
                          <span class="swatch-value bg_white"></span>
                          <img class="lazyload" data-src="images/products/cable-white.jpg" src="images/cable-white.jpg" alt="image-product">
                        </li>
                        <li class="list-color-item color-swatch">
                          <span class="tooltip">Cream</span>
                          <span class="swatch-value bg_cream"></span>
                          <img class="lazyload" data-src="images/products/cable-cream.jpg" src="images/cable-cream.jpg" alt="image-product">
                        </li>
                        <li class="list-color-item color-swatch">
                          <span class="tooltip">Grey</span>
                          <span class="swatch-value bg_grey"></span>
                          <img class="lazyload" data-src="images/products/cable-grey.jpg" src="images/cable-grey.jpg" alt="image-product">
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div class="swiper-slide" lazy="true">
                  <div class="card-product style-8 border-0 bg_grey-11">
                    <div class="card-product-wrapper">
                      <a class="product-img" href="/product-detail">
                        <img class="lazyload img-product" data-src="images/products/item3.png" src="images/item3.png" alt="image-product">
                        <img class="lazyload img-hover" data-src="images/products/item3.png" src="images/item3.png" alt="image-product">
                      </a>
                      <div class="list-product-btn absolute-2">
                        <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                          <span class="icon icon-bag"></span>
                    ...
                    <div class="card-product-info text-center">
                      <a class="title link" href="/product-detail">Beats Studio Buds</a>
                      <span class="price"><i class="fa fa-inr"></i> 20,000</span>
                      <ul class="list-color-product justify-content-center">
                        <li class="list-color-item color-swatch active">
                          <span class="tooltip">White</span>
                          <span class="swatch-value bg_white"></span>
                          <img class="lazyload" data-src="images/products/headphone-white.jpg" src="images/headphone-white.jpg" alt="image-product">
                        </li>
                        <li class="list-color-item color-swatch">
                          <span class="tooltip">Red</span>
                          <span class="swatch-value bg_red"></span>
                          <img class="lazyload" data-src="images/products/headphone-red2.jpg" src="images/headphone-red2.jpg" alt="image-product">
                        </li>
                        <li class="list-color-item color-swatch">
                          <span class="tooltip">Black</span>
                          <span class="swatch-value bg_dark"></span>
                          <img class="lazyload" data-src="images/products/headphone-black.jpg" src="images/headphone-black.jpg" alt="image-product">
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div class="swiper-slide" lazy="true">
                  <div class="card-product style-8 border-0 bg_grey-11">
                    <div class="card-product-wrapper">
                      <a class="product-img" href="/product-detail">
                        <img class="lazyload img-product" data-src="images/products/item4.png" src="images/item4.png" alt="image-product">
                        <img class="lazyload img-hover" data-src="images/products/item4.png" src="images/item4.png" alt="image-product">
                      </a>
                      <div class="list-product-btn absolute-2">
                        <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                          <span class="icon icon-bag"></span>
                    ...
                    <div class="card-product-info text-center">
                      <a class="title link" href="/product-detail">Blue Ocean Band</a>
                      <span class="price"><i class="fa fa-inr"></i> 899</span>
                      <ul class="list-color-product justify-content-center">
                        <li class="list-color-item color-swatch active">
                          <span class="tooltip">Black</span>
                          <span class="swatch-value bg_dark"></span>
                          <img class="lazyload" data-src="images/products/albert-black.jpg" src="images/albert-black.jpg" alt="image-product">
                        </li>
                        <li class="list-color-item color-swatch">
                          <span class="tooltip">Orange</span>
                          <span class="swatch-value bg_orange-3"></span>
                          <img class="lazyload" data-src="images/products/albert-orange.jpg" src="images/albert-orange.jpg" alt="image-product">
                        </li>
                        <li class="list-color-item color-swatch">
                          <span class="tooltip">White</span>
                          <span class="swatch-value bg_white"></span>
                          <img class="lazyload" data-src="images/products/albert-white2.jpg" src="images/albert-white2.jpg" alt="image-product">
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div class="swiper-slide" lazy="true">
                  <div class="card-product style-8 border-0 bg_grey-11">
                    <div class="card-product-wrapper">
                      <a class="product-img" href="/product-detail">
                        <img class="lazyload img-product" data-src="images/products/item5.png" src="images/item5.png" alt="image-product">
                        <img class="lazyload img-hover" data-src="images/products/item5.png" src="images/item5.png" alt="image-product">
                      </a>
                      <div class="list-product-btn absolute-2">
                        <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                          <span class="icon icon-bag"></span>
                    ...
                    <div class="card-product-info text-center">
                      <a class="title link" href="/product-detail">3-in-1 Wireless Charging</a>
                      <span class="price"><i class="fa fa-inr"></i> 5,999</span>
                      <ul class="list-color-product justify-content-center">
                        <li class="list-color-item color-swatch active">
                          <span class="tooltip">White</span>
                          <span class="swatch-value bg_white"></span>
                          <img class="lazyload" data-src="images/products/wireless-charging-white.jpg" src="images/wireless-charging-white.jpg" alt="image-product">
                        </li>
                        <li class="list-color-item color-swatch">
                          <span class="tooltip">Black</span>
                          <span class="swatch-value bg_dark"></span>
                          <img class="lazyload" data-src="images/products/wireless-charging-black.jpg" src="images/wireless-charging-black.jpg" alt="image-product">
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div class="swiper-slide" lazy="true">
                  <div class="card-product style-8 border-0 bg_grey-11">
                    <div class="card-product-wrapper">
                      <a class="product-img" href="/product-detail">
                        <img class="lazyload img-product" data-src="images/products/item6.png" src="images/item6.png" alt="image-product">
                        <img class="lazyload img-hover" data-src="images/products/item6.png" src="images/item6.png" alt="image-product">
                      </a>
                      <div class="list-product-btn absolute-2">
                        <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                          <span class="icon icon-bag"></span>
                    ...
                    <div class="card-product-info text-center">
                      <a class="title link" href="/product-detail">USB-C Charge Cable</a>
                      <span class="price"><i class="fa fa-inr"></i> 9,999</span>
                      <ul class="list-color-product justify-content-center">
                        <li class="list-color-item color-swatch active">
                          <span class="tooltip">Black</span>
                          <span class="swatch-value bg_dark"></span>
                          <img class="lazyload" data-src="images/products/cable-black3.jpg" src="images/cable-black3.jpg" alt="image-product">
                        </li>
                        <li class="list-color-item color-swatch">
                          <span class="tooltip">White</span>
                          <span class="swatch-value bg_white"></span>
                          <img class="lazyload" data-src="images/products/cable-white3.jpg" src="images/cable-white3.jpg" alt="image-product">
                        </li>
                      </ul>
                    </div>
                  </div>
            ...
            <div class="nav-sw disable-line nav-next-slider nav-next-product box-icon w_46 round">
              <span class="icon icon-arrow-left"></span>
            </div>
            <div class="nav-sw disable-line nav-prev-slider nav-prev-product box-icon w_46 round">
              <span class="icon icon-arrow-right"></span>
            </div>
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="collection-item-circle hover-img">
                    <a class="collection-image img-style" href="/shop-collection">
                      <img class="lazyloaded" data-src="images/collections/cable.svg" alt="collection-img" src="images/cable.svg">
                    </a>
                    <div class="collection-content text-center">
                      <a class="link title fw-5 text-line-clamp-1" href="/shop-collection">Cables</a>
                    </div>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="collection-item-circle hover-img">
                    <a class="collection-image img-style" href="/shop-collection">
                      <img class="lazyloaded" data-src="images/collections/screen-protection.svg" alt="collection-img" src="images/screen-protection.svg">
                    </a>
                    <div class="collection-content text-center">
                      <a class="link title fw-5 text-line-clamp-1" href="/shop-collection">Screen protection</a>
                    </div>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="collection-item-circle hover-img">
                    <a class="collection-image img-style" href="/shop-collection">
                      <img class="lazyloaded" data-src="images/collections/chargers.svg" alt="collection-img" src="images/chargers.svg">
                    </a>
                    <div class="collection-content text-center">
                      <a class="link title fw-5 text-line-clamp-1" href="/shop-collection">Chargers</a>
                    </div>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="collection-item-circle hover-img">
                    <a class="collection-image img-style" href="/shop-collection">
                      <img class="lazyloaded" data-src="images/collections/audio.svg" alt="collection-img" src="images/audio.svg">
                    </a>
                    <div class="collection-content text-center">
                      <a class="link title fw-5 text-line-clamp-1" href="/shop-collection">Audio</a>
                    </div>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="collection-item-circle hover-img">
                    <a class="collection-image img-style" href="/shop-collection">
                      <img class="lazyloaded" data-src="images/collections/wireless-chargers.svg" alt="collection-img" src="images/wireless-chargers.svg">
                    </a>
                    <div class="collection-content text-center">
                      <a class="link title fw-5 text-line-clamp-1" href="/shop-collection">Wireless Chargers</a>
                    </div>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="collection-item-circle hover-img">
                    <a class="collection-image img-style" href="/shop-collection">
                      <img class="lazyloaded" data-src="images/collections/magSafe.svg" alt="collection-img" src="images/magSafe.svg">
                    </a>
                    <div class="collection-content text-center">
                      <a class="link title fw-5 text-line-clamp-1" href="/shop-collection">MagSafe</a>
                    </div>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="collection-item-circle hover-img">
                    <a class="collection-image img-style" href="/shop-collection">
                      <img class="lazyloaded" data-src="images/collections/gaming.svg" alt="collection-img" src="images/gaming.svg">
                    </a>
                    <div class="collection-content text-center">
                      <a class="link title fw-5 text-line-clamp-1" href="/shop-collection">Gaming</a>
                    </div>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="collection-item-circle hover-img">
                    <a class="collection-image img-style" href="/shop-collection">
                      <img class="lazyloaded" data-src="images/collections/storage.svg" alt="collection-img" src="images/storage.svg">
                    </a>
                    <div class="collection-content text-center">
                      <a class="link title fw-5 text-line-clamp-1" href="/shop-collection">Storage</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide" lazy="true">
                <div class="collection-item-v4 st-lg hover-img">
                  <div class="collection-inner">
                    <a class="collection-image img-style radius-10 o-hidden" href="/shop-collection">
                      <img class="lazyload" data-src="images/collections/accessories2_b1.jpg" src="images/accessories2_b1.jpg" alt="collection-img">
                    </a>
                    <div class="collection-content text-start wow fadeInUp" data-wow-delay="0s">
                      ...
                      <a class="tf-btn btn-line collection-other-link fw-6" href="/shop-collection"><span>Shop Collection</span><i class="icon icon-arrow1-top-left"></i></a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="swiper-slide" lazy="true">
                <div class="collection-item-v4 st-lg hover-img">
                  <div class="collection-inner">
                    <a class="collection-image img-style radius-10 o-hidden" href="/shop-collection">
                      <img class="lazyload" data-src="images/collections/accessories2_b2.jpg" src="images/accessories2_b2.jpg" alt="collection-img">
                    </a>
                    <div class="collection-content text-start wow fadeInUp" data-wow-delay="0s">
      ...
      <section class="flat-spacing-25 pt_0">
        <div class="container">
          ...
          <div class="wrap-carousel">
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide" lazy="true">
                  <div class="card-product style-8">
                    ...
                    <div class="card-product-info text-center">
                      <a class="title link" href="/product-detail">Beats Studio Buds</a>
                      <span class="price"><i class="fa fa-inr"></i> 23,999</span>
                      <ul class="list-color-product justify-content-center">
                        <li class="list-color-item color-swatch">
                          <span class="tooltip">White</span>
                          <span class="swatch-value bg_white"></span>
                ...
                <div class="swiper-slide" lazy="true">
                  <div class="card-product style-8">
                    ...
                    <div class="card-product-info text-center">
                      <a class="title link" href="/product-detail">Case with MagSafe</a>
                      <span class="price"><i class="fa fa-inr"></i> 1,999</span>
                      <ul class="list-color-product justify-content-center">
                        <li class="list-color-item color-swatch active">
                          <span class="tooltip">Blue</span>
                          <span class="swatch-value bg_blue-2"></span>
                ...
                <div class="swiper-slide" lazy="true">
                  <div class="card-product style-8">
                    <div class="card-product-wrapper">
                      <a class="product-img" href="/product-detail">
                        <img class="lazyload img-product" data-src="images/products/item7.png" src="images/item7.png" alt="image-product">
                        <img class="lazyload img-hover" data-src="images/products/item7.png" src="images/item7.png" alt="image-product">
                      </a>
                      <div class="list-product-btn absolute-2">
                        <a href="#" class="box-icon bg_white wishlist btn-icon-action">
                          <span class="icon icon-heart"></span>
                    ...
                    <div class="card-product-info text-center">
                      <a class="title link" href="/product-detail">Wireless Charger MagSafe</a>
                      <span class="price"><i class="fa fa-inr"></i> 21,899</span>
                      <ul class="list-color-product justify-content-center">
                        <li class="list-color-item color-swatch">
                          <span class="tooltip">White</span>
                          <span class="swatch-value bg_white"></span>
                          <img class="lazyload" data-src="images/products/wireless-charging-white2.jpg" src="images/wireless-charging-white2.jpg" alt="image-product">
                        </li>
                        <li class="list-color-item color-swatch active">
                          <span class="tooltip">Black</span>
                          <span class="swatch-value bg_dark"></span>
                          <img class="lazyload" data-src="images/products/wireless-charging-black2.jpg" src="images/wireless-charging-black2.jpg" alt="image-product">
                        </li>
                      </ul>
                      <a href="#shoppingCart" data-bs-toggle="modal" class="tf-btn tf-btn-loading">
                        ADD TO CART
                ...
                <div class="swiper-slide" lazy="true">
                  <div class="card-product style-8">
                    ...
                    <div class="card-product-info text-center">
                      <a class="title link" href="/product-detail">3-in-1 Wireless Charging</a>
                      <span class="price"><i class="fa fa-inr"></i> 29,999</span>
                      <ul class="list-color-product justify-content-center">
                        <li class="list-color-item color-swatch">
                          <span class="tooltip">White</span>
                          <span class="swatch-value bg_white"></span>
                ...
                <div class="swiper-slide" lazy="true">
                  <div class="card-product style-8">
                    ...
                    <div class="card-product-info text-center">
                      <a class="title link" href="/product-detail">Blue Ocean Band</a>
                      <span class="price"><i class="fa fa-inr"></i> 999</span>
                      <ul class="list-color-product justify-content-center">
                        <li class="list-color-item color-swatch active">
                          <span class="tooltip">Black</span>
                          <span class="swatch-value bg_dark"></span>
                ...
                <div class="swiper-slide" lazy="true">
                  <div class="card-product style-8">
                    ...
                    <div class="card-product-info text-center">
                      <a class="title link" href="/product-detail">USB-C Charge Cable</a>
                      <span class="price"><i class="fa fa-inr"></i> 1,599</span>
                      <ul class="list-color-product justify-content-center">
                        <li class="list-color-item color-swatch active">
                          <span class="tooltip">Black</span>
                          <span class="swatch-value bg_dark"></span>
            ...
            <div class="nav-sw disable-line nav-next-slider nav-next-sell-1 box-icon w_46 round">
              <span class="icon icon-arrow-left"></span>
            </div>
            <div class="nav-sw disable-line nav-prev-slider nav-prev-sell-1 box-icon w_46 round">
              <span class="icon icon-arrow-right"></span>
            </div>
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="testimonial-item">
                      ...
                      <p class="text text-white">
                        ...
                        technologies, such as noise cancellation or surround
                        sound, depending on your preferences. Comfort is crucial
                        for long listening sessions
                      </p>
                      <div class="author box-author">
                        <div class="box-img d-md-none">
                          <img class="lazyload img-product" data-src="images/slider/electronic1.png" src="images/electronic1.png" alt="image-product">
                        </div>
                        <div class="content">
                          <div class="name text-white fw-6">Rekha Gupta</div>
                          <a class="metas link text-white" href="/product-detail">Purchase item :
                            <span class="fw-6">3-in-1 Wireless Charging</span></a>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="testimonial-item">
                      ...
                      <p class="text text-white">
                        Love love love! This product is so easy to use! I
                        absolutely love the this product. High-quality
                        headphones deliver a balanced and clear sound. Look for
                        headphones with good bass, clear mids, and crisp highs.
                      </p>
                      <div class="author box-author">
                        <div class="box-img d-md-none">
                          <img class="lazyload img-product" data-src="images/slider/electronic2.png" src="images/electronic2.png" alt="image-product">
                        </div>
                        <div class="content">
                          <div class="name text-white fw-6">Rajendra Prasad</div>
                          <a class="metas link text-white" href="/product-detail">Purchase item :
                            <span class="fw-6">Beats Studio Buds</span></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="box-img item-2 hover-img radius-10 o-hidden">
                      <div class="img-style">
                        <img class="lazyload" data-src="images/slider/electronic1.png" src="images/electronic1.png" alt="img-slider">
                      </div>
                    </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="box-img item-2 hover-img radius-10 o-hidden">
                      <div class="img-style">
                        <img class="lazyload" data-src="images/slider/electronic2.png" src="images/electronic2.png" alt="img-slider">
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-xl-3 col-md-6 col-12">
                  <div class="footer-infor">
                    ...
                    <ul>
                      ...
                      <li>
                        <p>
                          Email: <a href="#">ramcharangupta1666@gmail.com</a>
                        </p>
                      </li>
                      <li>
                        <p>Phone: <a href="#">(767) 205-7570</a></p>
                      </li>
                    </ul>
                    <a href="contact-1.html" class="tf-btn btn-line">Get direction<i class="icon icon-arrow1-top-left"></i></a>
                    <ul class="tf-social-icon d-flex gap-10">
                      <li>
                        <a href="#" class="box-icon w_34 round social-facebook social-line"><i class="icon fs-14 icon-fb"></i></a>
                      </li>
                      <li>
                        <a href="#" class="box-icon w_34 round social-twiter social-line"><i class="icon fs-12 icon-Icon-x"></i></a>
                      </li>
                      <li>
                        <a href="#" class="box-icon w_34 round social-instagram social-line"><i class="icon fs-14 icon-instagram"></i></a>
                      </li>
                      <li>
                        <a href="#" class="box-icon w_34 round social-tiktok social-line"><i class="icon fs-14 icon-tiktok"></i></a>
                      </li>
                      <li>
                        <a href="#" class="box-icon w_34 round social-pinterest social-line"><i class="icon fs-14 icon-pinterest-1"></i></a>
                      </li>
                    </ul>
                  </div>
                </div>
                <div class="col-xl-3 col-md-6 col-12 footer-col-block">
                  ...
                  <ul class="footer-menu-list tf-collapse-content">
                    ...
                    <li>
                      <a class="footer-menu_item" href="/delivery-return">
                        Returns + Exchanges
                      </a>
                    </li>
                    <li>
                      <a class="footer-menu_item" href="/shipping-delivery">Shipping</a>
                    </li>
                    <li>
                      <a class="footer-menu_item" href="/terms-conditions">Terms & Conditions</a>
                    </li>
                  </ul>
                </div>
                <div class="col-xl-3 col-md-6 col-12 footer-col-block">
                  ...
                  <ul class="footer-menu-list tf-collapse-content">
                    <li>
                      <a class="footer-menu_item" href="/about-us">About Us</a>
                    </li>
                    <li>
                      <a class="footer-menu_item" href="/shop-collection">Visit Our Store</a>
                    </li>
                    <li>
                      <a class="footer-menu_item" href="/contact">Contact Us</a>
                    </li>
                    <li>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="footer-bottom-wrap d-flex gap-20 flex-wrap justify-content-between align-items-center">
                    <div class="footer-menu_item">
                      © 2025 URBANLUXE. All Rights Reserved
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="mb-canvas-content">
        <div class="mb-body">
          <ul class="nav-ul-mb" id="wrapper-menu-navigation">
            ...
            <li class="nav-mb-item">
              <a class="collapsed mb-menu-link current" href="/shop-collection">
                <span>Shop</span>
              </a>
            </li>
            <li class="nav-mb-item">
              <a class="collapsed mb-menu-link current" href="/about-us">
                <span>About Us</span>
              </a>
            </li>
            <li class="nav-mb-item">
          ...
          <div class="mb-other-content">
            <div class="d-flex group-icon">
              <a class="site-nav-icon" href="/wishlist"><i class="icon icon-heart"></i>Wishlist</a>
            </div>
            <div class="mb-notice">
              <a class="text-need" href="/contact">Need help ?</a>
            </div>
            <ul class="mb-info">
              <li>Address: Hyderabad, Telangana, India - 500081</li>
              <li>Email: <b>ramcharangupta1666@gmail.com</b></li>
              <li>Phone: <b>(767) 205-7570</b></li>
            </ul>
          </div>
        </div>
        <div class="mb-bottom">
     ...
     <div class="offcanvas offcanvas-start canvas-mb toolbar-shop-mobile" id="toolbarShopmb">
      ...
      <div class="mb-canvas-content">
        <div class="mb-body">
          <ul class="nav-ul-mb" id="wrapper-menu-navigation">
            <li class="nav-mb-item">
              <a class="tf-category-link mb-menu-link" href="/shop-default">
                <div class="image">
            ...
            <li class="nav-mb-item">
              <a class="tf-category-link has-children collapsed mb-menu-link" href="/shop-default">
                <div class="image">
        ...
        <div class="mb-bottom">
          <a class="tf-btn fw-5 btn-line" href="/shop-default">View all collection<i class="icon icon-arrow1-top-left"></i></a>
        </div>
      </div>
    </div>
    <!-- /toolbarShopmb -->
          ...
          <div class="wrap">
            <div class="tf-mini-cart-threshold">
              ...
              <div class="tf-progress-msg">
                Buy
                <span class="price fw-6"><i class="fa fa-inr"></i> 150</span>
                more to enjoy
                ...
                <div class="tf-mini-cart-sroll">
                  <div class="tf-mini-cart-items">
                    <div class="tf-mini-cart-item">
                      <div class="tf-mini-cart-image">
                        <a href="/product-detail">
                          <img src="images/white-2.jpg" alt="">
                        </a>
                      </div>
                      <div class="tf-mini-cart-info">
                        <a class="title link" href="/product-detail">Eufy E220 Indoor Cam</a>
                    ...
                    <div class="tf-mini-cart-item">
                      <div class="tf-mini-cart-image">
                        <a href="/product-detail">
                          <img src="images/white-3.jpg" alt="">
                        </a>
                      </div>
                      <div class="tf-mini-cart-info">
                        <a class="title link" href="/product-detail">Apple HomePod mini</a>
                        <div class="price fw-6">
                          <i class="fa fa-inr"></i> 1,500
                        </div>
                        <div class="tf-mini-cart-btns">
                      ...
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <div class="tf-minicart-recommendations-item">
                            ...
                            <div class="tf-minicart-recommendations-item-infos flex-grow-1">
                              <a class="title" href="/product-detail">Apple HomePod mini</a>
                              <div class="price">
                                <i class="fa fa-inr"></i> 1,500
                              </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                          <div class="tf-minicart-recommendations-item">
                            ...
                            <div class="tf-minicart-recommendations-item-infos flex-grow-1">
                              <a class="title" href="/product-detail">Google Nest Audio</a>
                              <div class="price">
                                <i class="fa fa-inr"></i> 1,500
                              </div>
                            </div>
                  ...
                  <div class="tf-mini-cart-tool-content">
                    <div class="tf-mini-cart-tool-text">
                      ...
                      <div class="tf-gift-wrap-infos">
                        ...
                        Only
                        <span class="price fw-6"><i class="fa fa-inr"></i> 5.00</span>
                      </div>
                    </div>
                  ...
                  <div class="tf-compare-offcanvas">
                    <div class="tf-compare-item">
                      <div class="position-relative">
                        ...
                        <a href="/product-detail">
                          <img class="radius-3" src="images/orange-1.jpg" alt="">
                        </a>
                      </div>
                    </div>
                    <div class="tf-compare-item">
                      <div class="position-relative">
                        ...
                        <a href="/product-detail">
                          <img class="radius-3" src="images/pink-1.jpg" alt="">
                        </a>
                      </div>
                    </div>
                  </div>
        ...
        <div class="modal-content">
          ...
          <div class="wrap">
            <div class="tf-product-info-item">
              <div class="image">
                <img src="images/orange-1.jpg" alt="">
              </div>
              <div class="content">
                <a href="/product-detail">Best EarBuds</a>
                <div class="tf-product-info-price">
                  <!-- <div class="price-on-sale"><i class="fa fa-inr"></i> 8.00</div>
                                <div class="compare-at-price"><i class="fa fa-inr"></i> 10.00</div>
                                <div class="badges-on-sale"><span>20</span>% OFF</div> -->
                  <div class="price"><i class="fa fa-inr"></i> 18.00</div>
                </div>
              </div>
            </div>
            ...
            <div class="tf-product-info-buy-button">
              <form class="">
                <a href="#" class="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Add to cart -�</span><span class="tf-qty-price"><i class="fa fa-inr"></i> 18.00</span></a>
                ...
                <div class="w-100">
                  <a href="#" class="btns-full">Buy with <img src="images/paypal.png" alt=""></a>
            ...
            <div class="tf-product-info-wrap position-relative">
              <div class="tf-product-info-list">
                <div class="tf-product-info-title">
                  <h5>
                    <a class="link" href="/product-detail">Best EarBuds</a>
                  </h5>
                </div>
                ...
                <div class="tf-product-info-buy-button">
                  <form class="">
                    <a href="#" class="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Add to cart -�</span><span class="tf-qty-price"><i class="fa fa-inr"></i> 8.00</span></a>
                ...
                <div>
                  <a class="tf-btn fw-6 btn-line" href="/product-detail">View full details<i class="icon icon-arrow1-top-left"></i></a>
                </div>
              </div>
            </div>
          </div>
